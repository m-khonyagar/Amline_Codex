...
import { useGeneratePromoCode } from '../api/promo-codes'
...
const SinglePromoCodeForm = ({ className, onCancel, onSuccess }) => {
  ...
  const mutation = useGeneratePromoCode()
  ...
  return (
    ...
    >
      ...
      <InputField label="عبارت کد تخفیف" name="code" />
