...
export const DailyCallsReport = ({ data, duration }) => {
  return (
    <div className="p-5 bg-white rounded-2xl border border-zinc-200">
      <div className="flex justify-between items-start pb-4 mb-2 border-b border-zinc-200">
        <div>
          <h3 className="text-zinc-900 text-xl font-medium">گزارش تماس‌ بر اساس روز</h3>
          <p className="text-[#61E0AD] text-sm mt-2">تارگت روزانه: ۱۵۰۰ تماس</p>
        </div>
