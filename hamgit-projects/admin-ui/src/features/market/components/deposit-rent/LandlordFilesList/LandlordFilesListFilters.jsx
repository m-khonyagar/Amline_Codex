...
import { CloseIcon, FunnelIcon, TomanIcon } from '@/components/icons'
...
export const LandlordFilesListFilters = () => {
  ...
  const getFilterDisplayValue = (filter) => {
    ...
    switch (id) {
      ...
      case 'min_deposit':
        return `رهن از: ${numberSeparator(value)} تومان`
      case 'max_deposit':
        return `رهن تا: ${numberSeparator(value)} تومان`
      case 'min_rent':
        return `اجاره از: ${numberSeparator(value)} تومان`
      case 'max_rent':
        return `اجاره تا: ${numberSeparator(value)} تومان`
      case 'min_area':
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <PermissionGuard requiredRoles={['SUPERUSER']}>
            <span className="mr-auto">
              <ExportPhonesExcel type={PhoneExportTypeEnum.LANDLORD_FILE} />
            </span>
          </PermissionGuard>
        </div>
        ...
        <Form methods={methods} onSubmit={applyFilters}>
          <div className="grid grid-cols-3 gap-x-6">
            ...
            <SelectField
              ...
              label="مونوپول"
              name="monopoly"
              options={[{ label: 'همه', value: null }, ...MonopolyOptions]}
            />
