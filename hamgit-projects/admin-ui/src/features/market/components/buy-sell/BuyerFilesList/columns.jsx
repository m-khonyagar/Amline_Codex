...
import { CallStatusOptions, FileStatusOptions } from '@/data/enums/market_enums'
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent dir="rtl" align="end">
            <DropdownMenuItem asChild>
              <Link to={`/market/buy-sell/buyer/${file.id}`}>مشاهده</Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <Link to={`/market/buy-sell/buyer/${file.id}/edit`}>ویرایش</Link>
            </DropdownMenuItem>
            {onRestore && (
