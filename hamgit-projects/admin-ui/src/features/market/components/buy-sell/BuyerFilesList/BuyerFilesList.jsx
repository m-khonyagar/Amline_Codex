...
import { BuyerFilesListFilters } from './BuyerFilesListFilters'
import { BuyerFilesListRestore } from './BuyerFilesListRestore'

export const BuyerFilesList = ({ className, isArchive = false }) => {
  ...
  return (
    <>
      <DataTable
        ...
        filtersComponent={BuyerFilesListFilters}
