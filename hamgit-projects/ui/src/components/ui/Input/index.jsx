      ...
      >
        ...
        <div
          className={cn(
            ...
            wrapperClassName,
            selectedItems ? 'items-start' : 'items-center'
          )}
        >
          {label && horizontalMode && (
            <label className={classes.input__label} htmlFor={id}>
          ...
          {!!selectedItems && <div className="w-full min-h-[44px] p-3">{selectedItems}</div>}
          ...
          {suffixIcon && (
            <div
              ...
              className={cn(classes['input__suffix-icon'], !!selectedItems && 'mt-3')}
            >
              {suffixIcon}
            </div>
          )}
        ...
        {showCaption && <p className={cn(classes.input__caption, captionClassName)}>{caption}</p>}
      </div>
    )
  }
)
