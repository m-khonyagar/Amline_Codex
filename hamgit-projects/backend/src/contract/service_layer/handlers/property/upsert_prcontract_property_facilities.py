...
from contract.service_layer.dtos import UpsertPRContractPropertyFacilitiesDto
from core.types import CurrentUser
from shared.domain.entities.property import Property
from unit_of_work import UnitOfWork


def upsert_prcontract_property_facilities_handler(
    contract_id: int,
    data: UpsertPRContractPropertyFacilitiesDto,
    ...
    with uow:
        ...
        prc_step = PRContractStep.PROPERTY_FACILITIES
        ...
        property_dict_data = data.model_dump(exclude_unset=True)
        ...
        elif contract_step.is_completed and not property.facilities_completed:
